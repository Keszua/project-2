// konfigurator ciastek (projekt kilkudniowy)
...
class CookieMakerApp {
    ...
    _run() {
        this.app.listen(3000, 'localhost', () => console.log('Start to http://localhost:3000'));
    };
    ...
    getAddonsFromReq(req) {
        ...
        return cookieAddons ? JSON.parse(cookieAddons) : []; // jeśli istnieją, to je sparsuj, jeśli nie, to wstaw pustą tablicę
    };
