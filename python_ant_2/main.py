...
def run(document):
    ...
    morowka['mrowa0'] = {   # pierwsze, domyślne wartości
        ...
        'odwlok'    : "m236.5,81.132178c0,0 1.967212,-23.60655 7.540981,-27.868844c5.573769,-4.262294 26.885238,-7.540982 36.393432,-3.278688c9.508194,4.262294 28.85245,12.131143 38.688513,31.803269c9.836063,19.672126 5.901638,29.508188 1.311475,36.721301c-4.590163,7.213112 -17.049175,16.721306 -52.131132,2.62295c-35.081957,-14.098356 -31.803269,-28.196713 -31.803324,-28.345307c0.000055,0.148594 0.000055,-11.654681 0.000055,-11.654681z"
    }
    ...
    morowka['mrowa1'] = {
        ...
        'odwlok'    : "m228 66c0,0 10,28 61,55 25,19 85,-8 111,3 16,6 17,3 17,3 0,0 -15,-3 -12,-21 3,-18 -4,-34 -29,-50 -25,-17 -35,-25 -90,-27 -31,1 -39,9 -44,11 -6,5 -16,19 -14,26z",
    }
    ...
    aktualna['czolka'] =     morowka['mrowa1']['czolka']
    aktualna['glowa'] =      morowka['mrowa1']['glowa']
    ...
    aktualna['odwlok'] =     morowka['mrowa1']['odwlok']
    ...
    def rysujMrowke():
        ...
        panelA <= svg.path( id="odwłok",     d=f"M{odl},0 {aktualna['odwlok']}",  fill_opacity="null", stroke_opacity="null", stroke_width=strokeWidth, stroke=kolorStroke[0], fill=kolorFill[0])
        panelA <= legenda
    ...
    polecenia <= f"Krok {krok}: wybierz " + html.B("połączenie tułowia z odwłokiem.")
...
# OBSLOGA PRZYCISKU WYBIERZ
    ...
    def bind_click_dalej(ev):
        ...
        if krok == 1:
            # aktualna['polaczenie']
            polecenia.text = ""
            polecenia <= f"Krok {krok}:" + html.B(" połączenie tułowia z odwłokiem.")
