...
def run(document):
    ...
    morowka['mrowa0'] = {   # pierwsze, domyślne wartości
        ...
        'glowa': "m93.421035,116.947355c-6.05263,-12.89474 -6.57894,-8.1579 -4.47368,-19.47369c2.10526,-11.31579 -0.52632,-2.89473 3.94737,-14.21052c4.47368,-11.31579 13.94737,-17.63158 20.52631,-20.26316c6.57895,-2.63158 17.36842,0 17.36842,0c0,0 2.36842,1.84211 3.42106,5c1.05263,3.15789 -2.89474,30 -1.57895,31.84211c1.31579,1.8421 -20.78947,22.89473 -19.73684,22.63157c1.05263,-0.26315 -11.57895,-0.26315 -14.73685,13.68421c-3.15789,13.94737 -10.26315,-5.78947 -10.26315,-5.78947c0,0 13.42105,-7.89474 5.26315,-13.94737",
        'cialo': {
        ...
        'polaczenie' : {
            'rodzaj': "ukryty",
            'd': "m135.016385,78.181359c0,0 5.901638,0 5.737646,-0.148595c0.163992,0.148595 0.163992,15.230557 0,15.081963c0.163992,0.148594 -6.065515,0.804332 -6.229506,0.655738c0.163992,0.148594 0.49186,-15.589106 0.49186,-15.589106z",
            'len': 5,
            'strokeWidth': 1,
        },
        'odwlok'    : "m136.5,81.132178c0,0 1.967212,-23.60655 7.540981,-27.868844c5.573769,-4.262294 26.885238,-7.540982 36.393432,-3.278688c9.508194,4.262294 28.85245,12.131143 38.688513,31.803269c9.836063,19.672126 5.901638,29.508188 1.311475,36.721301c-4.590163,7.213112 -17.049175,16.721306 -52.131132,2.62295c-35.081957,-14.098356 -31.803269,-28.196713 -31.803324,-28.345307c0.000055,0.148594 0.000055,-11.654681 0.000055,-11.654681z"
    }
    ...
    morowka['mrowa1'] = {
        ...
        'polaczenie' : {
            'rodzaj' : "pojedynczy",
            'd': "m135.0,99.76729c-2.55319,-13.19149 3.40425,-30.21277 6.80851,-38.72341c3.40426,-8.51064 11.06383,10.6383 11.48936,15.74468c0.42553,5.10639 -8.51064,13.61703 -6.38298,19.14894c2.12766,5.53191 14.89362,12.34043 8.93617,14.04255c-5.95744,1.70213 -15.74468,4.68085 -17.02127,0.42554c-1.2766,-4.25532 -1.2766,2.55319 -3.82979,-10.6383z",
            'len': 14,
            'strokeWidth': 1,
        },
        'odwlok'    : "m140.0,81.132178c0,0 1.967212,-23.60655 7.540981,-27.868844c5.573769,-4.262294 26.885238,-7.540982 36.393432,-3.278688c9.508194,4.262294 28.85245,12.131143 38.688513,31.803269c9.836063,19.672126 5.901638,29.508188 1.311475,36.721301c-4.590163,7.213112 -17.049175,16.721306 -52.131132,2.62295c-35.081957,-14.098356 -31.803269,-28.196713 -31.803324,-28.345307c0.000055,0.148594 0.000055,-11.654681 0.000055,-11.654681z"
    }
    ...
    morowka['mrowa2'] = {
        ...
        'polaczenie' : {
            'rodzaj' : "podwojny",
            'd' : "m139,69.57121c1.36838,23.67125 13.20818,6.64998 16.61244,-1.86066c3.40426,-8.51064 11.06383,10.6383 11.48936,15.74468c0.42553,5.10639 0.11681,8.12683 -6.38298,19.14894c-6.49979,11.02211 -5.49854,-12.75761 -11.45599,-11.05549c-5.95744,1.70213 -5.94074,46.64163 -11.92323,15.71965c-5.98248,-30.92198 0.29202,-61.36837 1.6604,-37.69712z",
            'len': 30,
            'strokeWidth': 1,
        },
    ...
    aktualna['odwlok'] =     morowka['mrowa0']['odwlok']
...
# WYBIERANIE ODPOWIEDNICH ELEMENTOW MROWKI
    ...
    krokiText = [
        "Połączenie tułowia z odwłokiem."
        "Czy ma kolce?"
    ]
#-----------------------------------------------------------------------------
#-----------------------------------------------------------------------------
...
# OBSLOGA PRZYCISKU WYBIERZ
    ...
    def bind_click_dalej(ev):
        ...
        if krok == 1:
            # aktualna['polaczenie']
            polecenia.text = ""
            polecenia <= f"Krok {krok}:" + html.B("natepny krok połączenie tułowia z odwłokiem.")
